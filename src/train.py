...
def train(conf: omegaconf.DictConfig) -> None:
    ...
    experiment_name = conf.train.model_name + '_' + conf.data.target_identification + '_' + conf.model.subword_combiner + '_' + conf.model.words_combiner + '_' + str(conf.train.seed)
